...
/**
 * Provides the XSL stylesheet content for browser-friendly sitemap display.
 * The generated sitemap.xsl transforms XML into a readable HTML table
 * when the sitemap is opened directly in a browser.
 */
class SitemapXslTemplate
{
