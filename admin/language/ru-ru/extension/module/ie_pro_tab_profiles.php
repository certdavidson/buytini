...
$_['profile_upload_tooltip'] = 'Загрузить профиль';
$_['profile_download_tooltip'] = 'Скачать выбранный профиль';
$_['profile_or'] = 'ИЛИ';
...
$_['profile_i_want_orders_product_data'] = 'Заказы + Данные о товарах';
...
$_['profile_import_spreadsheet_remodal_description'] = '        <h3>1.- Создание нового проекта и настройка API</h3>
        <p>По умолчанию доступ к таблицам Google невозможен через Google API. Вам нужно перейти на облачную платформу Google, создать новый проект и настроить его для предоставления доступа к электронным таблицам.</p>
        По  <a href="https://youtu.be/8DDt8p3gd4M" target="_blank">ссылке</a> Вы найдете новый видеоурок по созданию нового проекта, активации API, создание JSON файла и настройка разрешений.
        </br></br>
        <h3>2.- Загрузка файла JSON</h3>%s
        </br>
        <h3>3.- Открытие доступа к файлу Google Таблиц для своего аккаунта</h3>
        <ol>
            <li>Создайте файл в Google Таблицах <b>в корневой директории</b></li>
            <li><b>Откройте доступ </b> к файлу для своего "Сервисного аккаунта": <b>%s</b>
            <li>Получите Google Sheets ID как показано на видео по ссылке -> <a target="_blank" href="https://youtu.be/8DDt8p3gd4M?t=172">Video tutorial</a></li>
        </ol>
';
...
$_['profile_import_force_refresh_cache'] = 'Принудительное обновление кэша';
$_['profile_import_force_refresh_cache_help'] = 'Запрос CURL PHP иногда загружает не обновляемую версию файла с URL-адреса, при включенной этой опции в URL-адрес CURL будет добавлен случайный параметр для принудительного обновления кэша.';
$_['profile_import_http_authentication'] = 'HTTP аутентификация';
...
$_['profile_import_http_username'] = 'Имя пользователя';
$_['profile_import_http_password'] = 'Пароль';
...
$_['profile_import_products_images_legend'] = 'Базовая настройка изображений';
...
$_['profile_import_products_no_check_duplicates'] = 'Настройка удаления дубликатов';
$_['profile_import_products_no_check_duplicates_link'] = '<b>ВАЖНО</b>: Нажмите чтобы прочесть!';
$_['profile_import_products_no_check_duplicates_help'] = '  <p>If you enable this option, the system won\'t check if there are duplicated products in your
...
$_['profile_import_products_autoseo_gerator_name_model'] = 'Автоматическая генерация ключевых слов из имени товара + модель продукта';
...
$_['profile_import_column_config_thead_disable_non_named'] = 'Выключить все безымянные';
...
$_['profile_error_profile_id_empty'] = 'Параметр ID профиля не найден.';
...
$_['profile_import_ftp_sftp_help'] = 'На вашем сервере должна быть установлена и активирована PHP библиотека <b>ssh2</b>.';
$_['progress_export_ftp_sftp_error_ssh2'] = 'PHP библиотека <b>ssh2</b> не найдена, Вам (или службе поддержки хостинга) необходимо установить и активировать ее.';
$_['progress_export_ftp_sftp_errorconnect'] = 'Произошла ошибка перед соединением по SFTP, проверьте настройки сервера и порта.';
...
$_['profile_import_error_category_id_attribute_missing_or_incorrect'] = 'ID атрибута отсутствует или не корректно';
$_['profile_import_error_category_value_attribute_invalid'] = 'Ошибочное значение атрибута';
$_['profile_import_error_missing_column_mapping'] = 'Не найдена настройка колонок для ';
$_['profile_import_error_expected_file_upload_columns_mapping'] = 'Настройка колонок: ожидается загрузка файла';
...
$_['profile_import_mapping_categories_in_other_xml_node_label'] = 'Категории в другом XML node';
$_['profile_import_mapping_categories_main_xml_node_label'] = 'Категории главной ноды';
$_['profile_import_mapping_categories_id_attribute_label'] = 'ID атрибута';
$_['profile_import_mapping_categories_parent_id_attribute'] = 'ID родительского атрибута';
$_['profile_import_mapping_categories_parent_id_attribute_label'] = 'ID родительского атрибута (не обязательно)';
$_['profile_import_mapping_categories_value_attribute_label'] = 'Значение атрибута';
$_['profile_import_mapping_categories_in_other_xml_node'] = 'Категории в другом XML node';
$_['profile_import_mapping_categories_in_other_xml_node_remodal_title'] = 'Категории в другом XML node';
...
$_['profile_import_mapping_categories_in_other_xml_node_link'] = '<b>ВАЖНО</b>: Нажмите чтобы прочесть!';
$_['profile_import_error_categories_xml_file_upload_expected'] = 'Ожидается загрузка XML - файла';
$_['profile_import_error_categories_xml_invalid_attribute_name'] = 'Отсутствует или не корректно имя атрибута:';
$_['profile_upload_data_is_missing'] = 'Отсутствуют данные в загружаемом профиле';
$_['profile_upload_data_format_is_invalid'] = 'Данные в профиле не корректны или повреждены';
$_['profile_import_column_name_select_insert_manually'] = '--- Ручная вставка ---';
$_['profile_import_xml_get_main_nodes'] = 'Получение главных нод';
$_['profile_import_columns_not_analyzed_yet'] = '<b>Необязательный шаг</b>: Если вы хотите извлечь колонки из файла, нажмите на кнопку, чтобы проанализировать файл.';
$_['profile_import_columns_already_analyzed'] = '<b>Колонки успешно проанализированы</b>. Используйте данный переключатель чтобы выбрать наименования колонок или выберите "<b>Вставить вручную</b>" для самостоятельного заполнения колонок.';
$_['profile_import_categories_not_analyzed_yet'] = 'В настоящее время не обнаружено никаких категорий. Нажмите на кнопку, чтобы загрузить данные и определить текущие категории.';
$_['profile_import_categories_already_analyzed'] = 'Категории успешно проанализированы. Теперь вы можете выполнить сопоставление категорий.';
$_['profile_import_main_xml_nodes_not_analyzed_yet'] = '<b>Необязательный шаг</b>: Если вы хотите узнать основные ноды XML из Вашего файла, нажмите на кнопку, чтобы проанализировать файл.';
$_['profile_import_main_xml_nodes_already_analyzed'] = '<b>Основные ноды успешно обнаружены</b>. Используйте данный переключатель чтобы выбрать основные ноды или выберите "<b>Вставить вручную</b>"для самостоятельного заполнения.';
$_['profile_import_profile_upload_successful'] = 'Профиль был успешно загружен';
$_['profile_import_profile_download_successful'] = 'Профиль был успешно скачен';
$_['profile_import_errors_downloading_remote_images_tpl'] = '<strong>Произошла ошибка при загрузке удаленных изображений, <a target="_blank" href="{log_url}">нажмите сюда</a> чтобы увидеть лог ошибок.</strong>';
$_['profile_error_server_limits_overloaded'] = 'Этот процесс перегружает серверные лимиты:<br><em>memory_limit</em>: <strong>{{memory_limit}}</strong><br><em>max_execution_time</em>: <strong>{{max_execution_time}}</strong><br><em>upload_max_filesize</em>: <strong>{{upload_max_filesize}}</strong>';
$_['profile_import_categories_already_detected'] = 'Категории уже обнаружены';
$_['profile_import_export_php_version_too_old'] = 'Для импорта или экспорта xls/xlsx файлов Ваша версия РНР должна быть не ниже 5.6.0';
$_['profile_import_duplicated_product_id_found'] = 'Система обнаружила дубликаты в Вашем файле, ID товара: %s. Данные товара: %s';
$_['profile_import_product_missing_description_default'] = 'Не известно';
$_['profile_import_export_conditional_expression_invalid_column_name'] = '<strong>%s</strong>: Ошибка условного выражения. Имя столбца отсутствует или написано с ошибкой: \'<em>%s</em>\'';
$_['profile_option_combinations_config_legend'] = 'Основные настройки комбинаций опций у товара';
$_['profile_options_combinations_number_label'] = 'Количество комбинаций опций';
$_['profile_options_combinations_prices_by_customer_group_label'] = 'Цены по группам клиентов';
$_['profile_options_combinations_points_by_customer_group_label'] = 'Баллы по группам клиентов';
$_['profile_options_combinations_images_number_label'] = 'Количество картинок';
$_['profile_options_combinations_discounts_number_label'] = 'Количество скидок';
$_['profile_options_combinations_specials_number_label'] = 'Количество акций';
$_['profile_options_combinations_image_number_error'] = 'Количество картинок не может быть более %s';
$_['profile_options_combinations_number_remodal_title'] = 'Количество комбинаций опций';
$_['profile_options_combinations_number_remodal_description'] = 'Значение данного параметра задает количество опций, которые вы хотите экспортировать или импортировать из каждого товара. Если есть товары, у которых больше опций, чем указано, то эти опции пропускаются. В противном случае, если есть товары, у которых меньше опций, чем указано в данном параметре, то столбцы этих опций будут пустыми.';
$_['profile_options_combinations_images_number_remodal_title'] = 'Количество картинок';
$_['profile_options_combinations_images_number_remodal_description'] = 'Значение данного параметра задает количество изображений для экспорта или импорта для каждого товара.';
$_['profile_options_combinations_points_by_customer_group_title'] = 'Баллы по группам клиентов';
$_['profile_options_combinations_points_by_customer_group_description'] = 'Если этот параметр активен, цена атрибута будет импортирована-экспортирована с разбивкой по группам клиентов';
$_['profile_options_combinations_prices_by_customer_group_title'] = 'Цены по группам клиентов';
$_['profile_options_combinations_prices_by_customer_group_description'] = 'Если этот параметр активен, цена атрибута будет импортирована или экспортирована с разбивкой по группам клиентов';
?>