...
$_['xlsx_sheet_name_orders_product_data'] = 'Данные о заказе и продукте';
...
$_['google_spreadsheet_export_finished'] = 'Данные отправлены в таблицу: "<b>%s</b>". <a target="_blank" href="%s">Нажмите чтобы открыть</a>';
...
$_['progress_export_ftp_error_downloading_file'] = 'Произошла ошибка при загрузке файла по FTP. Пожалуйста, проверьте правильность файла, наличие разрешения или включение пассивного режима.';
