<?php
// Heading
$_['heading_title']    					= 'Кредиты Приватбанк, Монобанк, Sense bank, А-банк, Плати позже, ПУМБ';
...
$_['text_ukrcredits'] 					= '<a target="_blank" href="https://payparts2.privatbank.ua/ipp/"><img src="view/image/payment/pp_logo.png" alt="Оплата частями" title="Оплата частями" style="width: 25px;;height:25px;" /></a> <a target="_blank" href="https://payparts2.privatbank.ua/ipp/"><img src="view/image/payment/ip_logo.png" alt="Мгновенная рассрочка" title="Мгновенная рассрочка" style="width: 25px;;height:25px;" /></a> <a target="_blank" href="https://t.me/chast_mbbankbot"><img src="view/image/payment/mb_logo.png" alt="Покупка частями" title="Покупка частями" style="width: 25px;;height:25px;" /></a> <a target="_blank" href="https://t.me/chast_mbbankbot"><img src="view/image/payment/ab_logo.png" alt="Легкая рассрочка" title="Легкая рассрочка" style="width: 25px;height:25px;" /></a><a target="_blank" href="https://a-bank.com.ua/contacts"><img src="view/image/payment/aa_logo.png" alt="Плати частями" title="Плати частями" style="width: 25px; height: 25px;"></a><a target="_blank" href="https://www.paylater.com.ua/"><img src="view/image/payment/pl_logo.png" alt="Плати позже" title="Плати позже" style="width: 25px; height: 25px;"></a><a target="_blank" href="https://www.pumb.ua/mahazyny-partnery-rozstrochky#form"><img src="view/image/payment/pu_logo.png" alt="Оплата частями" title="Оплата частями" style="width: 25px; height: 25px;"></a>';
...
$_['text_paymentparts_url_ab']			= '<p>Для получения идентификатора и пароля, необходимо открыть счет в Sense bankе и <a target="_blank" href="https://sensebank.com.ua/installment/">стать партнером</a></p>';
$_['text_paymentparts_url_sb']			= '<p>Для получения данных, необходимо открыть счет в Sense bankе и <a target="_blank" href="https://sensebank.ua/partneri-internet-magazinam">стать партнером</a></p>';
$_['text_paymentparts_url_aa']			= '<p>Для получения идентификатора и пароля, необходимо открыть счет в А-банке и <a target="_blank" href="https://a-bank.com.ua/contacts">стать партнером</a></p>';
$_['text_paymentparts_url_pl']			= '<p>Получите Токен от менеджера компании <a target="_blank" href="https://www.paylater.com.ua/">"Плати Позже"</a></p>';
$_['text_paymentparts_url_pu']			= '<p>Для получения данных необходимо <a target="_blank" href="https://www.pumb.ua/mahazyny-partnery-rozstrochky#form">стать партнером</a></p>';
...
$_['text_ukrcredits_license_help']		= 'Если Вы столкнулись с проблемами при активации модуля, напишите нам в службу поддержки на e-mail ims@ukr.net, телеграм https://t.me/stealth_od или скайп stealth_od с указанием места покупки, номера заказа, домена, версии php и версии модуля';
$_['text_getdata']						= 'Получить/обновить данные по пакетам';
$_['text_callback_url']					= 'Callback url';
//Entry
$_['entry_shop_id']						= 'Идентификатор магазина:';
$_['entry_shop_name']					= 'Название партнера:';

$_['entry_login'] 						= 'Login партнера / login:';
$_['entry_frame'] 						= 'Пароль партнера / frameSecretKey:';
$_['entry_partnerId'] 					= 'Id партнера / partnerId:';
$_['entry_shopId'] 						= 'Ідентифікатор точки продажу/shopId:';

$_['entry_credit_sub_products']			= 'Виды кредитов:';
$_['entry_subproduct'] 					= 'Код субпродукта/subproduct:';
$_['entry_gracePeriod'] 				= 'Льготный период/gracePeriod:';

$_['entry_token']						= 'Токен:';
$_['entry_shop_password']				= 'Пароль:';
$_['entry_point_of_sale_code']			= 'Код точки продаж:';
...
$_['entry_aa_merchantType_standart']	= '<b>«Плати частями»</b>';
$_['entry_pl_merchantType_standart']	= '<b>«Плати позже»</b>';
$_['entry_pu_merchantType_standart']	= '<b>«Оплата частями»</b>';
...
$_['entry_fix_markup']					= 'Использовать дополнительную наценку';
$_['entry_markup_additional']			= 'Дополнительная наценка';

$_['entry_available_terms']				= 'Доступные сроки кредитования:';
...
$_['entry_help_description']    		= 'Текст, выодящий в попапе при наведении на название кредита';
...
$_['tab_ab']							= '<img src="view/image/payment/ab_logo.png" alt="Легкая рассрочка" title="Легкая рассрочка" style="width: 25px; height: 25px;" /> Легкая рассрочка (Sense bank)';
$_['tab_sb'] 							= '<img src="view/image/payment/sb_logo.png" alt="Кредит" title="Кредит" style="width: 25px; height: 25px;" /> Кредит (Sense bank)';
$_['tab_aa']							= '<img src="view/image/payment/aa_logo.png" alt="Плати частями" title="Плати частями" style="width: 25px; height: 25px;" /> Плати частями (А-Банк)';
$_['tab_pl']							= '<img src="view/image/payment/pl_logo.png" alt="Плати позже" title="Плати позже" style="width: 25px; height: 25px;" /> Плати позже';
$_['tab_pu']							= '<img src="view/image/payment/pu_logo.png" alt="Оплата частями" title="Оплата частями" style="width: 25px; height: 25px;" /> Оплата частями (ПУМБ)';
...
$_['help_available_terms']				= 'Введите доступные сроки кредитования через запятую без пробелов';
...
$_['help_fix_markup'] 					= 'Фиксированная наценка в зависимости от стоимости товара';
$_['help_markup_additional'] 			= 'Установите стоимости и наценки, пример на рисунке';
...
$_['help_pl_token'] 					= 'Введите токен и нажмите кнопку для получения всех актуальных данных по доступным пакетам';
$_['error_pl_connect'] 					= 'При подключении в серверу "Плати Позже" возникла ошибка, обратитесь к менеджеру. Ответ сервера:';
$_['error_pl_token'] 					= 'Ошибка при проверке токена: ';
$_['error_pl_packets'] 					= 'Ошибка при получении пакетов: ';
$_['text_pl_saved'] 					= 'Данные получены, сохраните настройки модуля';
$_['error_pl_save'] 					= 'Ошибка при сохранении пакетов';

$_['email_subject']  = 'Не удалось выдать ключ %s, php %s, версия %s';