...
// Text
// $_['text_cart']                      = 'Корзина';
$_['text_cart']                      = 'Товары <span class="modal-header__count">%s</span>';
...
$_['text_agree']                     = 'Я прочитал и согласен с правилами <a class="colorbox fancybox agree" href="%s" alt="%s">%s</a>';
...
$_['text_average_shipping_price'] = 'Ориентировочная стоимость:';
$_['button_shipping_cost'] = 'Оплачивается отдельно, по прибытии в Украину';
$_['button_payment_cost'] = 'Без учета доставки и растаможки';
...
$_['text_summary_payment_address'] = 'Адрес плательщика';
...
$_['text_need_checkout'] = 'Войдите для оформления заказа';

$_['text_code_total'] = '%s %s на сумму';
$_['text_code_total_forms'] = ['товар', 'товары', 'товаров'];

$_['text_price_tax'] = 'таможенные платежи';
$_['total_text_price_tax'] = 'Таможенные платежи (ориентировочные)';

$_['error_login_sms'] = 'Авторизуйтесь, пожалуйста, для продления заказа';
