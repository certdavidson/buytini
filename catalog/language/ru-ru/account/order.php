...
$_['button_view'] = 'Просмотр заказа';
$_['button_track'] = 'Трекинг заказа';
$_['button_reorder'] = 'Повторить заказ';
$_['button_orders'] = 'Мои заказы';

$_['text_track'] = 'Трекинг заказа';
$_['text_finish_shipping'] = 'Доставлено';
$_['text_finish_shipping_waiting'] = 'Ожидается';
// Error
