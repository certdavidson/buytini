...
// $_['text_success'] = 'Товар %s додано до списку бажань!';
...
$_['text_success'] = 'Товар додано до вашого обраного <span class="ms-1">😍</span>';
$_['text_remove'] = 'Товар успішно видалено з обраного <span class="ms-1">☹️</span>';
$_['text_product_not_found'] = 'Товар не знайдено!';

$_['text_try_latest'] = 'Занадто багато запитів. Спробуйте пізніше.';